...
puzzle_pieces = [OrangePiece.new, OrangePiece.new, RedPiece.new]
...
solving_piece_combinations.each do |solving_piece_combination|
  ...
  puzzle.valid_solutions.each do |valid_solution|
    ...
    rendered_starting_position.rendered_file( "solutions/scenario3/puzzle_#{counter}.png" )
    rendered_solution_position.rendered_file( "solutions/scenario3/solution_#{counter}.png" )
